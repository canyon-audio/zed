...
use git::{
    ...
    repository::{
        ...
        LogSource, PushOptions, Remote, RepoPath, ResetMode, Worktree, resolve_worktree_directory,
    },
    status::{
...
impl GitRepository for FakeGitRepository {
    ...
    fn create_worktree(
        ...
        let working_directory = self
            ...
            .to_path_buf();
        let directory = resolve_worktree_directory(&working_directory, &worktree_directory);
        async move {
